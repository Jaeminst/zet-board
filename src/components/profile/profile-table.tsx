                    ...
                    {profile.roles !== undefined && (
                      <DropdownMenuContent align="start">
                        {profile.roles
                          ...
                          .map(role => (
                            <DropdownMenuItem key={role} onClick={() => handleSelectRole(profile.idx, role)}>
                              {role}
                            </DropdownMenuItem>
                          ))}
                      </DropdownMenuContent>
                ...
                <TableCell className="flex flex-row justify-center items-center p-2">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This action cannot be undone. This will permanently delete your profile from the
                  ...
                  <div className="w-12">
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        dispatchProfile({ type: ProfileActionTypes.SwapProfileIdxUp, payload: profile.idx })
                      }
                    >
                    ...
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        dispatchProfile({ type: ProfileActionTypes.SwapProfileIdxDown, payload: profile.idx })
                      }
                    >
